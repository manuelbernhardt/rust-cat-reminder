...
pub fn run(ip_addr: IpAddr, port: u16, network_tx: Sender<NetworkEvent>, shutdown_hook: Arc<AtomicBool>) {
            ...
            match event {
                ServiceEvent::ServiceResolved(info) => {
                    ...
                    if is_other_service {
                        ...
                        network_tx.send(NetworkEvent::NodeListUpdated(cat_reminder_instances.clone())).expect("Failed to send updated cat reminder instances");
                    }
                }
